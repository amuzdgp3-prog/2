...
type Tab = 'machines' | 'locations' | 'catalog' | 'terminals' | 'staff' | 'cashless' | 'toys' | 'consumption' | 'expenses' | 'audit';
...
function LocationRentCard({ locationId, onDone, onError }: TabProps & { locationId: number }) {
...
function ExpensesTab({ onDone, onError }: TabProps) {
